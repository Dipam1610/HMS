...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #136a8a, #267871); background-size: cover;">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="index.php" style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6>SIGN UP / LOGIN</h6></a>
          </li>
    ...
    animation: mover 1s infinite alternate;">
          <img src="images/ambulance1.png" alt="" style="width: 20%;padding-left: 5px;margin-top: 150px;margin-left: 40px;margin-bottom:15px">
      </div>
      ...
      <div style="color: white;">
         ...
         <div class="col-md-4" style="margin-top: 5%;right: 8%">
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;">
            <div class="card-body">
              <center>
                <i class="fa fa-hospital-o fa-3x" aria-hidden="true" style="color:#267871"></i>
                <br>
              ...
              <form class="form-group" method="POST" action="func.php">
                <div class="row" style="margin-top: 10%">
                  ...
                  <div class="col-md-8" style="margin-top: 8%"><input type="password" class="form-control" name="password2" placeholder="Password*" required/></div><br><br>
                </div>
                <div class="row">
                 <div class="col-md-4" style="padding-left: 195px;margin-top: 10%">
